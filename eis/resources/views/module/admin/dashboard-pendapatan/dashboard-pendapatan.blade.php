                                                ...
                                                <div class="col-md-12">
                                                    <div class="table-responsive">
                                                        <table class="table table-striped"
                                                            ...
                                                            <thead>
                                                            <tr>
                                                                <th style="white-space: pre-wrap;" rowspan="2">Tahun
                                                                </th>
                                                                <th style="white-space: pre-wrap;" rowspan="2">Bulan
                                                                </th>
                                                                <th colspan="5"
                                                                    style="text-align:center;color:#448cff;white-space: pre-wrap">
                                                                    Rawat Jalan
                                                                </th>
                                                                <th colspan="5"
                                                                    style="text-align:center;color:red;white-space: pre-wrap;">
                                                                    Rawat Inap
                                                                </th>
                                                            </tr>
                                                            <tr>
                                                                <th style="color:#448cff;white-space: pre-wrap;">Jumlah
                                                                    Kasus
                                                                </th>
                                                                <th style="color:#448cff;white-space: pre-wrap">Jumlah
                                                                    Kasus Pending
                                                                </th>
                                                                <th style="color:#448cff;white-space: pre-wrap">
                                                                    Pengajuan Klaim
                                                                </th>
                                                                <th style="color:#448cff;white-space: pre-wrap">Pending
                                                                    / Tidak Layak
                                                                </th>
                                                                <th style="color:#448cff;white-space: pre-wrap">
                                                                    Realisasi Klaim
                                                                </th>
                                                                <th style="color:red;white-space: pre-wrap">Jumlah
                                                                    Kasus
                                                                </th>
                                                                <th style="color:red;white-space: pre-wrap">Jumlah Kasus
                                                                    Pending
                                                                </th>
                                                                <th style="color:red;white-space: pre-wrap">Pengajuan
                                                                    Klaim
                                                                </th>
                                                                <th style="color:red;white-space: pre-wrap">Pending /
                                                                    Tidak Layak
                                                                </th>
                                                                <th style="color:red;white-space: pre-wrap">Realisasi
                                                                    Klaim
                                                                </th>
                                                            </tr>
                                                            </thead>
