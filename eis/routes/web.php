...
//    Route::get('/get-detail-kunjungan-pasien','DashboardController@getDetailKun');
    ...
    Route::get('/get-sebaran-pasienlama', 'MainController@getSebaranPasienLama');
    Route::get('/get-kota-kab-map', 'MainController@getKotaMap');
...
Route::post('/save-map-kabupaten', 'MainController@saveMapKabupaten');
