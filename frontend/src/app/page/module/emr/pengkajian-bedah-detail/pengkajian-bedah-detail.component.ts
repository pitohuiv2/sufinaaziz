...
import { OrderBedahComponent } from '../order-bedah/order-bedah.component';

@Component({
  selector: 'app-pengkajian-bedah-detail',
  templateUrl: './pengkajian-bedah-detail.component.html',
  styleUrls: ['./pengkajian-bedah-detail.component.scss']
})
export class PengkajianBedahDetailComponent implements OnInit, AfterViewInit {
  cc: any = {}
  nomorEMR: any = '-'
  namaEMR: any
  listData: any = {}
  ...
  constructor(public rekamMedis: RekamMedisComponent,
    public orderBedah: OrderBedahComponent,
