...
import { EmrDetailComponent } from '../emr-detail/emr-detail.component';

@Component({
  selector: 'app-emr-detail-form',
  templateUrl: './emr-detail-form.component.html',
  styleUrls: ['./emr-detail-form.component.scss']
})
export class EmrDetailFormComponent implements OnInit {
  cc: any = {}
  nomorEMR: any = '-'
  namaEMR: any
  listData: any = {}
  ...
  constructor(public rekamMedis: RekamMedisComponent,
    public orderBedah: EmrDetailComponent,
