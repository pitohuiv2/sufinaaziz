...
@Component({
  selector: 'app-map-administrasi-otomatis',
  templateUrl: './map-administrasi-otomatis.component.html',
  styleUrls: ['./map-administrasi-otomatis.component.scss']
})
export class MapAdministrasiOtomatisComponent implements OnInit {
  item: any = {}
  column: any[]
  dataSource: any[]
  listRuangan: []
  ...
  getProduk() {
    this.apiService.get("sysadmin/general/get-combo-administrasi?produk=1&objectruanganfk=" + this.item.ruangan.id).subscribe(e => {
  ...
  hapusAll() {
    ...
    this.apiService.post('sysadmin/general/save-map-administrasi-otomatis', objSave).subscribe(e => {
      this.batalInput();
      this.apiService.get("sysadmin/general/get-combo-administrasi?produk=1&objectruanganfk=" + this.item.ruangan.id).subscribe(dat => {
        ...
        this.dataSource = dat.data.listakomodasi;
      });
    })
  }
