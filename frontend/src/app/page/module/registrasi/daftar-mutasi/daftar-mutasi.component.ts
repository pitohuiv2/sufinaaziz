...
@Component({
  selector: 'app-daftar-mutasi',
  templateUrl: './daftar-mutasi.component.html',
  styleUrls: ['./daftar-mutasi.component.scss'],
  providers: [ConfirmationService]
})
export class DaftarMutasiComponent implements OnInit {
  ...
  LoadCache() {
    var chacePeriode = this.cacheHelper.get('DafarMutasi');
  ...
  getData() {
    ...
    this.cacheHelper.set('DafarMutasi', chacePeriode);

    this.apiService.get("registrasi/get-daftar-mutasi?"
  ...
  mutasiKeun(e){
    ...
    this.apiService.get("registrasi/get-apd?noregistrasi="
      ...
      if (dataAntrian != undefined) {
        ...
        this.cacheHelper.set('CacheMutasiRanap', cacheSet);
