...
class SisruteC extends  ApiController
{
    ...
    protected function userSisrute()
    {
        return $this->settingDataFixed('userIdSisrute', $this->getKdProfile());
    }
    protected function passwordSisrute()
    {
        return $this->settingDataFixed('passwordSisrute', $this->getKdProfile());
    }
    function getUrlSisrute()
    {
        return $this->settingDataFixed('urlBridgingSisrute', $this->getKdProfile());
    }
    public function getRujukan(Request $request)
    {
        ...
        if ($err) {
            $result = array(
                'metaData' => array(
                    'code' => 400,
                    'message' => 'Gagal menghubungkan ke SISRUTE (' . $url . ')'
                ),
            );
        } else {
