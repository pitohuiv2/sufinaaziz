        ...
        <div class="page-wrapper">
            ...
            <div class="page-header m-t-50">
                                ...
                                <div class="row" style="margin-top:10px">
                                    <div class="col-md-12 col-xl-3">
                                        <div class="card widget-card-1"
                                            style="border: 1px solid rgba(69, 90, 100, 0.14);">
                                            <div class="card-block-small">
                                                ...
                                                <div>
                                                    <span class="f-left m-t-10 text-muted">
                                                        <i
                                                            class="text-c-blue f-16 feather icon-alert-triangle m-r-10"></i>
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="row align-items-end">
                    ...
                    <div  data-idruang="<?= $v['idruangan'] ?>"       data-namaruang="<?= $v['namaruangan'] ?>" readonly
                    class="col-md-12 col-xl-3 mytooltip tooltip-effect-5 tooltip-item klikDetails" style="cursor: pointer"
                   >
        ...
        <script type="text/javascript">
          $(function(){
            $('.klikDetails').on('click', function(e) {
                    e.preventDefault();
                    var username = $(this).attr("data-kode");
                    $.ajax({
                    type: 'GET',
                    url: <?=  base_url() ?> + '/get-detail-kamar',
                    data: {
                        ruanganId: kode
                    },
                    cache: false,
