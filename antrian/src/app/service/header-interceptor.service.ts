...
export class HeaderInterceptorService implements HttpInterceptor {
	...
	intercept(req: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
		let tokenPATOK = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJraW9zayJ9.kGBIoqR0wUd_uJYNyvWq3fZuNyu_AK8NTrcehzdDgTQ8EBVs-xrcH7Y-PUvRgPc_rgNK62WIeA5iIeN1e0O_-g.MjAyMS0xMS0xOSAwOTo1MjowNw=='
