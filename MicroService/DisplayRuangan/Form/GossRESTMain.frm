...
Begin VB.Form GossRESTMain 
   ...
   Begin DisplayRuangan.Gossamer Gossamer1 
      Left            =   120
      Top             =   120
      _ExtentX        =   741
      _ExtentY        =   741
...
Sub minimize_to_tray()
    ...
    nid.hIcon = Me.Icon
    nid.szTip = "Display poli @transmedic" & vbNullChar
...
'        On Error Resume Next
        ...
        If URI = "\printvb\panggil" Then RespBody = frmPanggil.Panggil(Gossamer1.URLDecode(Params))
